 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VaId implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VaId';
    ...
    public function setVaId($va_id)
    {
        if ((mb_strlen($va_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $va_id when calling VaId., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($va_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $va_id when calling VaId., must be bigger than or equal to 10.');
        }
