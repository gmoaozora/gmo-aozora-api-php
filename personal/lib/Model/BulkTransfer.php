...
/**
 * BulkTransfer Class Doc Comment
 *
 * @category Class
 * @package  Ganb\Personal\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BulkTransfer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BulkTransfer';
    ...
    public function setItemId($item_id)
    {
        if ((mb_strlen($item_id) > 6)) {
            throw new \InvalidArgumentException('invalid length for $item_id when calling BulkTransfer., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($item_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $item_id when calling BulkTransfer., must be bigger than or equal to 1.');
        }
    ...
    public function setBeneficiaryBankCode($beneficiary_bank_code)
    {
        if ((mb_strlen($beneficiary_bank_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_bank_code when calling BulkTransfer., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($beneficiary_bank_code) < 4)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_bank_code when calling BulkTransfer., must be bigger than or equal to 4.');
        }
    ...
    public function setBeneficiaryBankName($beneficiary_bank_name)
    {
        if (!is_null($beneficiary_bank_name) && (mb_strlen($beneficiary_bank_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_bank_name when calling BulkTransfer., must be smaller than or equal to 30.');
        }
        if (!is_null($beneficiary_bank_name) && (mb_strlen($beneficiary_bank_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_bank_name when calling BulkTransfer., must be bigger than or equal to 1.');
        }
    ...
    public function setBeneficiaryBranchCode($beneficiary_branch_code)
    {
        if ((mb_strlen($beneficiary_branch_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_branch_code when calling BulkTransfer., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($beneficiary_branch_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_branch_code when calling BulkTransfer., must be bigger than or equal to 3.');
        }
    ...
    public function setBeneficiaryBranchName($beneficiary_branch_name)
    {
        if (!is_null($beneficiary_branch_name) && (mb_strlen($beneficiary_branch_name) > 15)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_branch_name when calling BulkTransfer., must be smaller than or equal to 15.');
        }
        if (!is_null($beneficiary_branch_name) && (mb_strlen($beneficiary_branch_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_branch_name when calling BulkTransfer., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $clearing_house_name 手形交換所番号 半角文字 入力する場合は、ALL０,ALLスペースであること 参考値、処理に利用しません
     *
     * @return $this
     */
    public function setClearingHouseName($clearing_house_name)
    {
        if (!is_null($clearing_house_name) && (mb_strlen($clearing_house_name) > 4)) {
            throw new \InvalidArgumentException('invalid length for $clearing_house_name when calling BulkTransfer., must be smaller than or equal to 4.');
        }
        if (!is_null($clearing_house_name) && (mb_strlen($clearing_house_name) < 4)) {
            throw new \InvalidArgumentException('invalid length for $clearing_house_name when calling BulkTransfer., must be bigger than or equal to 4.');
        }
    ...
    public function setAccountTypeCode($account_type_code)
    {
        if ((mb_strlen($account_type_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $account_type_code when calling BulkTransfer., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($account_type_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_type_code when calling BulkTransfer., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountNumber($account_number)
    {
        if ((mb_strlen($account_number) > 7)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling BulkTransfer., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($account_number) < 7)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling BulkTransfer., must be bigger than or equal to 7.');
        }
     ...
     *
     * @param string $beneficiary_name 受取人名 半角文字 振込許容文字を指定可 ただし、一部の非許容文字は、許容文字に変換を行います 30文字目まで有効（31文字目以降は切り捨てます）
     *
     * @return $this
     */
    public function setBeneficiaryName($beneficiary_name)
    {
        if ((mb_strlen($beneficiary_name) > 48)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_name when calling BulkTransfer., must be smaller than or equal to 48.');
        }
        if ((mb_strlen($beneficiary_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $beneficiary_name when calling BulkTransfer., must be bigger than or equal to 1.');
        }
    ...
    public function setTransferAmount($transfer_amount)
    {
        if ((mb_strlen($transfer_amount) > 20)) {
            throw new \InvalidArgumentException('invalid length for $transfer_amount when calling BulkTransfer., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($transfer_amount) < 1)) {
            throw new \InvalidArgumentException('invalid length for $transfer_amount when calling BulkTransfer., must be bigger than or equal to 1.');
        }
     ...
     * Sets new_code
     *
     * @param string $new_code 新規コード 半角文字 入力する場合は、数値またはスペースであること 参考値、処理に利用しません
     *
     * @return $this
     */
    public function setNewCode($new_code)
    {
        if (!is_null($new_code) && (mb_strlen($new_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $new_code when calling BulkTransfer., must be smaller than or equal to 1.');
        }
        if (!is_null($new_code) && (mb_strlen($new_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $new_code when calling BulkTransfer., must be bigger than or equal to 1.');
        }
    ...
    public function setEdiInfo($edi_info)
    {
        if (!is_null($edi_info) && (mb_strlen($edi_info) > 20)) {
            throw new \InvalidArgumentException('invalid length for $edi_info when calling BulkTransfer., must be smaller than or equal to 20.');
        }
        if (!is_null($edi_info) && (mb_strlen($edi_info) < 1)) {
            throw new \InvalidArgumentException('invalid length for $edi_info when calling BulkTransfer., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $transfer_designated_type 振込指定区分 半角文字 入力する場合は、7：電信のみ　またはスペースであること 参考値、処理に利用しません（入力にかかわらず、すべて7：電信扱いとなります）
     *
     * @return $this
     */
    public function setTransferDesignatedType($transfer_designated_type)
    {
        if (!is_null($transfer_designated_type) && (mb_strlen($transfer_designated_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $transfer_designated_type when calling BulkTransfer., must be smaller than or equal to 1.');
        }
        if (!is_null($transfer_designated_type) && (mb_strlen($transfer_designated_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $transfer_designated_type when calling BulkTransfer., must be bigger than or equal to 1.');
        }
     ...
     * Sets identification
     *
     * @param string $identification 識別表示 半角文字 本項目が「Y」であればEDI情報は振込先に通知、または省略/NULL/スペースであれば振込先には通知しません
     *
     * @return $this
     */
    public function setIdentification($identification)
    {
        if (!is_null($identification) && (mb_strlen($identification) > 1)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling BulkTransfer., must be smaller than or equal to 1.');
        }
        if (!is_null($identification) && (mb_strlen($identification) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling BulkTransfer., must be bigger than or equal to 1.');
        }
