...
class BulkTransferResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'total_count' => 'string',
        'total_amount' => 'string',
        'bulk_transfer_infos' => '\Ganb\Personal\Client\Model\BulkTransferInfo[]'
    ];
     ...
     *
     * @return \Ganb\Personal\Client\Model\BulkTransferInfo[]
     */
     ...
     *
     * @param \Ganb\Personal\Client\Model\BulkTransferInfo[] $bulk_transfer_infos 総合振込明細情報 総合振込明細のリスト 明細情報取得フラグが「True：取得する」、かつ明細情報取得結果フラグが「True：取得可」のときのみ設定します それ以外は項目自体を設定しません
     *
     * @return $this
     */
