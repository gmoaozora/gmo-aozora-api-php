...
/**
 * BulkTransferRequestResponse Class Doc Comment
 *
 * @category Class
 * @package  Ganb\Personal\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BulkTransferRequestResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BulkTransferRequestResponse';
    ...
    public function setAccountId($account_id)
    {
        if ((mb_strlen($account_id) > 29)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling BulkTransferRequestResponse., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($account_id) < 12)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling BulkTransferRequestResponse., must be bigger than or equal to 12.');
        }
    ...
    public function setResultCode($result_code)
    {
        if ((mb_strlen($result_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $result_code when calling BulkTransferRequestResponse., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($result_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_code when calling BulkTransferRequestResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setApplyNo($apply_no)
    {
        if ((mb_strlen($apply_no) > 16)) {
            throw new \InvalidArgumentException('invalid length for $apply_no when calling BulkTransferRequestResponse., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($apply_no) < 16)) {
            throw new \InvalidArgumentException('invalid length for $apply_no when calling BulkTransferRequestResponse., must be bigger than or equal to 16.');
        }
    ...
    public function setApplyEndDatetime($apply_end_datetime)
    {
        if (!is_null($apply_end_datetime) && (mb_strlen($apply_end_datetime) > 25)) {
            throw new \InvalidArgumentException('invalid length for $apply_end_datetime when calling BulkTransferRequestResponse., must be smaller than or equal to 25.');
        }
        if (!is_null($apply_end_datetime) && (mb_strlen($apply_end_datetime) < 25)) {
            throw new \InvalidArgumentException('invalid length for $apply_end_datetime when calling BulkTransferRequestResponse., must be bigger than or equal to 25.');
        }
