...
class TransactionsResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'count' => 'string',
        'transactions' => '\Ganb\Personal\Client\Model\Transaction[]'
    ];
     ...
     * Gets transactions
     *
     * @return \Ganb\Personal\Client\Model\Transaction[]
     */
     ...
     * Sets transactions
     *
     * @param \Ganb\Personal\Client\Model\Transaction[] $transactions 入出金明細情報リスト 該当する情報が無い場合は、空のリストを返却します
     *
     * @return $this
     */
