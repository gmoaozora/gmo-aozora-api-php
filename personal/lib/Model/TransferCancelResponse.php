...
/**
 * TransferCancelResponse Class Doc Comment
 *
 * @category Class
 * @package  Ganb\Personal\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransferCancelResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransferCancelResponse';
    ...
    public function setAccountId($account_id)
    {
        if ((mb_strlen($account_id) > 29)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling TransferCancelResponse., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($account_id) < 12)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling TransferCancelResponse., must be bigger than or equal to 12.');
        }
     ...
     *
     * @param string $cancel_target_key_class 取消対象キー区分 半角英数値 1:振込申請取消　2:振込受付取消　3:総合振込申請取消　4:総合振込受付取消
     *
     * @return $this
     */
    public function setCancelTargetKeyClass($cancel_target_key_class)
    {
        if ((mb_strlen($cancel_target_key_class) > 1)) {
            throw new \InvalidArgumentException('invalid length for $cancel_target_key_class when calling TransferCancelResponse., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($cancel_target_key_class) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cancel_target_key_class when calling TransferCancelResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setResultCode($result_code)
    {
        if ((mb_strlen($result_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $result_code when calling TransferCancelResponse., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($result_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_code when calling TransferCancelResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets apply_no
     *
     * @param string $apply_no 受付番号（振込申請番号） 半角数字 取り消し対象の番号
     *
     * @return $this
     */
    public function setApplyNo($apply_no)
    {
        if ((mb_strlen($apply_no) > 16)) {
            throw new \InvalidArgumentException('invalid length for $apply_no when calling TransferCancelResponse., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($apply_no) < 16)) {
            throw new \InvalidArgumentException('invalid length for $apply_no when calling TransferCancelResponse., must be bigger than or equal to 16.');
        }
     ...
     *
     * @param string $apply_end_datetime 振込依頼完了日時 半角文字 YYYY-MM-DDTHH:MM:SS+09:00形式 結果コードが、1:完了のときのみセット このリクエストの依頼が完了した日時を返却 それ以外は項目自体を設定しません
     *
     * @return $this
     */
    public function setApplyEndDatetime($apply_end_datetime)
    {
        if (!is_null($apply_end_datetime) && (mb_strlen($apply_end_datetime) > 25)) {
            throw new \InvalidArgumentException('invalid length for $apply_end_datetime when calling TransferCancelResponse., must be smaller than or equal to 25.');
        }
        if (!is_null($apply_end_datetime) && (mb_strlen($apply_end_datetime) < 25)) {
            throw new \InvalidArgumentException('invalid length for $apply_end_datetime when calling TransferCancelResponse., must be bigger than or equal to 25.');
        }
