...
/**
 * TransferRequestResultResponse Class Doc Comment
 *
 * @category Class
 * @package  Ganb\Personal\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransferRequestResultResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransferRequestResultResponse';
    ...
    public function setAccountId($account_id)
    {
        if ((mb_strlen($account_id) > 29)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling TransferRequestResultResponse., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($account_id) < 12)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling TransferRequestResultResponse., must be bigger than or equal to 12.');
        }
     ...
     * Sets result_code
     *
     * @param string $result_code 結果コード 半角数字 1:完了　2：未完了　8：期限切
     *
     * @return $this
     */
    public function setResultCode($result_code)
    {
        if ((mb_strlen($result_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $result_code when calling TransferRequestResultResponse., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($result_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_code when calling TransferRequestResultResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setApplyNo($apply_no)
    {
        if ((mb_strlen($apply_no) > 16)) {
            throw new \InvalidArgumentException('invalid length for $apply_no when calling TransferRequestResultResponse., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($apply_no) < 16)) {
            throw new \InvalidArgumentException('invalid length for $apply_no when calling TransferRequestResultResponse., must be bigger than or equal to 16.');
        }
     ...
     *
     * @param string $apply_end_datetime 振込依頼完了日時 半角文字 YYYY-MM-DDTHH:MM:SS+09:00形式 結果コードが、1:完了のときのみセット 振込申請番号の最も直近の依頼の完了日時を返却 それ以外は項目自体を設定しません
     *
     * @return $this
     */
    public function setApplyEndDatetime($apply_end_datetime)
    {
        if (!is_null($apply_end_datetime) && (mb_strlen($apply_end_datetime) > 25)) {
            throw new \InvalidArgumentException('invalid length for $apply_end_datetime when calling TransferRequestResultResponse., must be smaller than or equal to 25.');
        }
        if (!is_null($apply_end_datetime) && (mb_strlen($apply_end_datetime) < 25)) {
            throw new \InvalidArgumentException('invalid length for $apply_end_datetime when calling TransferRequestResultResponse., must be bigger than or equal to 25.');
        }
