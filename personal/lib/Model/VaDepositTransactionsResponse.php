...
class VaDepositTransactionsResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'count' => 'string',
        'va_transactions' => '\Ganb\Personal\Client\Model\VaTransaction[]'
    ];
     ...
     *
     * @return \Ganb\Personal\Client\Model\VaTransaction[]
     */
     ...
     *
     * @param \Ganb\Personal\Client\Model\VaTransaction[] $va_transactions 振込入金口座入金明細情報リスト 該当する情報が無い場合は、空のリストを返却します
     *
     * @return $this
     */
