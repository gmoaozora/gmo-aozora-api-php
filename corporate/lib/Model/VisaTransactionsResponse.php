 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VisaTransactionsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VisaTransactionsResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'count' => 'string',
        'visa_transactions' => '\Ganb\Corporate\Client\Model\VisaTransaction[]'
    ];
    ...
    protected static $setters = [
        ...
        'count' => 'setCount',
        'visa_transactions' => 'setVisaTransactions'
    ];
    ...
    protected static $getters = [
        ...
        'count' => 'getCount',
        'visa_transactions' => 'getVisaTransactions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['visa_transactions'] = isset($data['visa_transactions']) ? $data['visa_transactions'] : null;
    }
    ...
    public function setAccountId($account_id)
    {
        if ((mb_strlen($account_id) > 29)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling VisaTransactionsResponse., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($account_id) < 12)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling VisaTransactionsResponse., must be bigger than or equal to 12.');
        }
    ...
    public function setDateFrom($date_from)
    {
        if ((mb_strlen($date_from) > 10)) {
            throw new \InvalidArgumentException('invalid length for $date_from when calling VisaTransactionsResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($date_from) < 10)) {
            throw new \InvalidArgumentException('invalid length for $date_from when calling VisaTransactionsResponse., must be bigger than or equal to 10.');
        }
    ...
    public function setDateTo($date_to)
    {
        if ((mb_strlen($date_to) > 10)) {
            throw new \InvalidArgumentException('invalid length for $date_to when calling VisaTransactionsResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($date_to) < 10)) {
            throw new \InvalidArgumentException('invalid length for $date_to when calling VisaTransactionsResponse., must be bigger than or equal to 10.');
        }
     ...
     * Sets base_date
     *
     * @param string $base_date 基準日 半角文字 Visaデビット取引明細を照会した基準日を示します YYYY-MM-DD形式
     *
     * @return $this
     */
    public function setBaseDate($base_date)
    {
        if ((mb_strlen($base_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $base_date when calling VisaTransactionsResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($base_date) < 10)) {
            throw new \InvalidArgumentException('invalid length for $base_date when calling VisaTransactionsResponse., must be bigger than or equal to 10.');
        }
     ...
     * Sets base_time
     *
     * @param string $base_time 基準時刻 半角文字 Visaデビット取引明細を照会した基準時刻を示します HH:MM:SS+09:00形式
     *
     * @return $this
     */
    public function setBaseTime($base_time)
    {
        if ((mb_strlen($base_time) > 14)) {
            throw new \InvalidArgumentException('invalid length for $base_time when calling VisaTransactionsResponse., must be smaller than or equal to 14.');
        }
        if ((mb_strlen($base_time) < 14)) {
            throw new \InvalidArgumentException('invalid length for $base_time when calling VisaTransactionsResponse., must be bigger than or equal to 14.');
        }
    ...
    public function setNextItemKey($next_item_key)
    {
        if (!is_null($next_item_key) && (mb_strlen($next_item_key) > 24)) {
            throw new \InvalidArgumentException('invalid length for $next_item_key when calling VisaTransactionsResponse., must be smaller than or equal to 24.');
        }
        if (!is_null($next_item_key) && (mb_strlen($next_item_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_item_key when calling VisaTransactionsResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        if ((mb_strlen($count) > 7)) {
            throw new \InvalidArgumentException('invalid length for $count when calling VisaTransactionsResponse., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($count) < 1)) {
            throw new \InvalidArgumentException('invalid length for $count when calling VisaTransactionsResponse., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets visa_transactions
     *
     * @return \Ganb\Corporate\Client\Model\VisaTransaction[]
     */
    public function getVisaTransactions()
    {
        return $this->container['visa_transactions'];
    }

    /**
     * Sets visa_transactions
     *
     * @param \Ganb\Corporate\Client\Model\VisaTransaction[] $visa_transactions Visaデビット取引明細情報リスト 該当する情報が無い場合は、空のリストを返却します
     *
     * @return $this
     */
    public function setVisaTransactions($visa_transactions)
    {
        $this->container['visa_transactions'] = $visa_transactions;
