...
/**
 * VaListResponse Class Doc Comment
 *
 * @category Class
 * @package  Ganb\Corporate\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VaListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VaListResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'count' => 'string',
        'v_accounts' => '\Ganb\Corporate\Client\Model\VAccount[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['v_accounts'] = isset($data['v_accounts']) ? $data['v_accounts'] : null;
    }
    ...
    public function setBaseDate($base_date)
    {
        if ((mb_strlen($base_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $base_date when calling VaListResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($base_date) < 10)) {
            throw new \InvalidArgumentException('invalid length for $base_date when calling VaListResponse., must be bigger than or equal to 10.');
        }
    ...
    public function setBaseTime($base_time)
    {
        if ((mb_strlen($base_time) > 14)) {
            throw new \InvalidArgumentException('invalid length for $base_time when calling VaListResponse., must be smaller than or equal to 14.');
        }
        if ((mb_strlen($base_time) < 14)) {
            throw new \InvalidArgumentException('invalid length for $base_time when calling VaListResponse., must be bigger than or equal to 14.');
        }
     ...
     * Sets has_next
     *
     * @param bool $has_next 次一覧フラグ ・true=次一覧あり ・false=次一覧なし
     *
     * @return $this
     */
     ...
     * Sets next_item_key
     *
     * @param string $next_item_key 次一覧キー 半角英数字 次一覧フラグがfalseの場合は項目自体を設定しません
     *
     * @return $this
     */
    public function setNextItemKey($next_item_key)
    {
        if (!is_null($next_item_key) && (mb_strlen($next_item_key) > 24)) {
            throw new \InvalidArgumentException('invalid length for $next_item_key when calling VaListResponse., must be smaller than or equal to 24.');
        }
        if (!is_null($next_item_key) && (mb_strlen($next_item_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_item_key when calling VaListResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets count
     *
     * @param string $count 口座取得件数 半角数字
     *
     * @return $this
     */
    public function setCount($count)
    {
        if ((mb_strlen($count) > 7)) {
            throw new \InvalidArgumentException('invalid length for $count when calling VaListResponse., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($count) < 1)) {
            throw new \InvalidArgumentException('invalid length for $count when calling VaListResponse., must be bigger than or equal to 1.');
        }
     ...
     * Gets v_accounts
     *
     * @return \Ganb\Corporate\Client\Model\VAccount[]
     */
    public function getVAccounts()
    {
        return $this->container['v_accounts'];
    }

    /**
     * Sets v_accounts
     *
     * @param \Ganb\Corporate\Client\Model\VAccount[] $v_accounts 振込入金口座情報 振込入金口座情報のリスト 該当する情報が無い場合は空のリストを返却
     *
     * @return $this
     */
    public function setVAccounts($v_accounts)
    {
        $this->container['v_accounts'] = $v_accounts;
