...
/**
 * VaStatusCode Class Doc Comment
 *
 * @category Class
 * @package  Ganb\Corporate\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VaStatusCode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VaStatusCode';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['va_status_code']) && (mb_strlen($this->container['va_status_code']) > 1)) {
    ...
    {
        if (!is_null($va_status_code) && (mb_strlen($va_status_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $va_status_code when calling VaStatusCode., must be smaller than or equal to 1.');
        }
        if (!is_null($va_status_code) && (mb_strlen($va_status_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $va_status_code when calling VaStatusCode., must be bigger than or equal to 1.');
        }
