...
/**
 * VaIssueResponse Class Doc Comment
 *
 * @category Class
 * @package  Ganb\Corporate\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VaIssueResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VaIssueResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'va_list' => '\Ganb\Corporate\Client\Model\Va[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['va_list'] = isset($data['va_list']) ? $data['va_list'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['va_list'] === null) {
            $invalidProperties[] = "'va_list' can't be null";
        }
    ...
    public function setVaTypeCode($va_type_code)
    {
        if ((mb_strlen($va_type_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $va_type_code when calling VaIssueResponse., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($va_type_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $va_type_code when calling VaIssueResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setVaTypeName($va_type_name)
    {
        if ((mb_strlen($va_type_name) > 10)) {
            throw new \InvalidArgumentException('invalid length for $va_type_name when calling VaIssueResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($va_type_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $va_type_name when calling VaIssueResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $expire_date_time 有効期限日時 半角文字 YYYY-MM-DDTHH:MM:SS+09:00形式 振込入金口座種別コードが「2=継続型」の場合は、項目自体を設定しません
     *
     * @return $this
     */
    public function setExpireDateTime($expire_date_time)
    {
        if (!is_null($expire_date_time) && (mb_strlen($expire_date_time) > 25)) {
            throw new \InvalidArgumentException('invalid length for $expire_date_time when calling VaIssueResponse., must be smaller than or equal to 25.');
        }
        if (!is_null($expire_date_time) && (mb_strlen($expire_date_time) < 25)) {
            throw new \InvalidArgumentException('invalid length for $expire_date_time when calling VaIssueResponse., must be bigger than or equal to 25.');
        }
     ...
     *
     * @param string $va_holder_name_kana 振込入金口座名義カナ 半角文字
     *
     * @return $this
     */
    public function setVaHolderNameKana($va_holder_name_kana)
    {
        if ((mb_strlen($va_holder_name_kana) > 40)) {
            throw new \InvalidArgumentException('invalid length for $va_holder_name_kana when calling VaIssueResponse., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($va_holder_name_kana) < 1)) {
            throw new \InvalidArgumentException('invalid length for $va_holder_name_kana when calling VaIssueResponse., must be bigger than or equal to 1.');
        }
     ...
     * Gets va_list
     *
     * @return \Ganb\Corporate\Client\Model\Va[]
     */
    public function getVaList()
    {
        return $this->container['va_list'];
    }

    /**
     * Sets va_list
     *
     * @param \Ganb\Corporate\Client\Model\Va[] $va_list 振込入金口座リスト
     *
     * @return $this
     */
    public function setVaList($va_list)
    {
        $this->container['va_list'] = $va_list;
